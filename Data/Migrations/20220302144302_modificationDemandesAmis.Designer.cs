...
namespace NetAtlas.Data.Migrations
{
    ...
    [Migration("20220302144302_modificationDemandesAmis")]
    partial class modificationDemandesAmis
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetAtlas.Models.DemandeDAmis", b =>
                {
                    b.HasOne("NetAtlas.Models.NetAtlasUser", "Amis1")
                        .WithMany()
                        .HasForeignKey("Amis1ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("NetAtlas.Models.NetAtlasUser", "Amis2")
                        .WithMany()
                        .HasForeignKey("Amis2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
